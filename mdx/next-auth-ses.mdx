...
It took me a while to figure out how to get an SMTP connection string for Amazon Simple Email Service, but once I did I wrote this quick guide: [How to send email through Amazon SES with SMTP](https://www.notion.so/How-to-send-email-through-Amazon-SES-with-SMTP-e61f1f37e66445a392d1d892e49fd5c0).
