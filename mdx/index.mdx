...
<div className="bg-gray-50 border border-gray-200 rounded-lg px-4">
    ...
    <p>This website is a digital garden. It’s got {mdxData.length} posts, on a variety of different topics. You can [search through them](/search), or use one of these entry points:</p>
    - [Grade 12](/grade-12)
    - [Books](/books)
</div>
