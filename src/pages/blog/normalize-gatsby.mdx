...
description: Normalize.css is a set of CSS rules used to make all browsers render your styles consistently. You can import it easily into your Gatsby site when using JSX and React.
---
