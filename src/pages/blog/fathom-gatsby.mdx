...
description: Add Fathom analytics, version 1 or 2, to your Gatsby site and start tracking the number of visitors your site gets.
published: 2019-10-21
---

[Fathom](https://usefathom.com) offers simple and privacy-focused analytics that you can use for your Gatsby site. This method works with Fathom v1 or v2, since the tracking code on your website is the same for both versions. 
  ...
  plugins: [
    {
      ...
      options: {
        // trackingUrl is only necessary if you're self-hosting Fathom, otherwise this defaults to the hosted version of Fathom
