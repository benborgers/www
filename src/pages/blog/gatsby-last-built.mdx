...
description: You can get the time that your Gatsby site was last built using Gatsby's GraphQL queries. This can be useful in showing visitors how recently the site was built, and how fresh the content is. 
