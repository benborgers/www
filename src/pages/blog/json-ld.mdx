...
I want the title, description, and publish date to be really clear when Google indexes my blog posts. After some searching, I decided to add metadata to my articles in the `JSON-lD` format. 
