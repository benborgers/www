...
description: The navigator.sendBeacon() method makes POST requests without waiting for a response, and is more efficient than than  `fetch` or XMLHttpRequest. This might be helpful if you need to log analytics when a page is closed, or if you want to log errors quickly and efficiently. 
tags: javascript
