      ...
      <GridParent>
        ...
        <GridChild heading="Projects">
          <ul>
            ...
            <li>
              <a href="https://github.com/benborgers/potion">Potion</a>, an open-source hosted API that reverse-engineers <a href="https://www.notion.so/product">Notion</a>'s private API.
            </li>
            <li>
