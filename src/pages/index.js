...
export default () => {
  ...
  const description = "A 17 year old developer in Boston, Massachusetts who makes apps and websites. Currently in high school, and interned at IBM last summer."
