...
![](https://share.cleanshot.com/xe019Z/download)

- **Thalamus**: sensory relay station.
  - The only sense that bypasses the thalamus is the **olfactory bulb** for smell.

![](https://share.cleanshot.com/fxDAHH/download)
...
![](https://share.cleanshot.com/vio5A0/download)
...
- Parkinson’s Disease is decreased dopamine activity in the _substantia nigra_
