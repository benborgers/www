...
**Positive correlation**: high values of one correlate with high values of another. **Negative correlation**: high values of one correlate with *low* values of another. 
