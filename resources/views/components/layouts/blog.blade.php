...
<div class="font-public-sans">
    {{-- Desktop nav --}}
    <nav class="hidden sm:block h-screen fixed inset-y-0 left-0 bg-zinc-100 pt-16 w-16 space-y-6">
        ...
        <a href="{{ route('posts.index') }}" class="block group">
            <svg
                @class([
                    'mx-auto h-7 w-7 group-hover:scale-110 group-active:scale-95 transition-transform',
        ...
        <a href="https://twitter.com/benborgers" target="_blank" class="block group" onclick="fathom.trackGoal('E3LD3YS1')">
            <svg
                @class([
